                    ...
                    >
                        ...
                        <Grid container>
                            ...
                            <Grid item lg={6} md={6} sm={6} xs={6}>
                                ...
                                <span style={{ color: 'green' }}>
                                    <b>
                                        {state.teacher[0] ? state.teacher[0].firstName : notAvailable}
                                    </b>
                                </span>
                            </Grid>
                        </Grid>
                        ...
                        <Grid container>
                            <Grid item lg={6} md={6} sm={6} xs={6}>
                                ...
                                <span style={{ color: 'green' }}>
                                    <b>
                                        {state.startDateTime ? state.startDateTime : notAvailable
                                        }
                                    </b>
                                </span>
                            </Grid>
                            <Grid item lg={6} md={6} sm={6} xs={6}>
                                ...
                                <span style={{ color: 'green' }}>
                                    <b>
                                        {state.endDateTime ? state.endDateTime : notAvailable}
                                    </b>
                                </span>
                            </Grid>
                        </Grid>
